...
MyBattleTank-Linux-Debug:
	 $(PROJECTBUILD) MyBattleTank Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTank-Linux-DebugGame:
	 $(PROJECTBUILD) MyBattleTank Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTank-Linux-Shipping:
	 $(PROJECTBUILD) MyBattleTank Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTank-Linux-Test:
	 $(PROJECTBUILD) MyBattleTank Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTank:
	 $(PROJECTBUILD) MyBattleTank Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTankEditor-Linux-Debug:
	 $(PROJECTBUILD) MyBattleTankEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTankEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MyBattleTankEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTankEditor-Linux-Shipping:
	 $(PROJECTBUILD) MyBattleTankEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTankEditor-Linux-Test:
	 $(PROJECTBUILD) MyBattleTankEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MyBattleTankEditor:
	 $(PROJECTBUILD) MyBattleTankEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
