...
include(MyBattleTankSource.pri)
include(MyBattleTankHeader.pri)
...
MyBattleTank-Linux-Shipping.commands = $$build MyBattleTank Linux Shipping  -project="\"$$gameProjectFile\"" $$args
MyBattleTank-Linux-Test.commands = $$build MyBattleTank Linux Test  -project="\"$$gameProjectFile\"" $$args
MyBattleTank.commands = $$build MyBattleTank Linux Development  -project="\"$$gameProjectFile\"" $$args

MyBattleTankEditor-Linux-Debug.commands = $$build MyBattleTankEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
MyBattleTankEditor-Linux-DebugGame.commands = $$build MyBattleTankEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
MyBattleTankEditor-Linux-Shipping.commands = $$build MyBattleTankEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
